...
This repository contains the PyStrato software. Starting up as a part of the stratospheric weather balloon 
missions from the **[M2 TSI](http://m2tsi.eu)** from France, this tool has become a fully customizable 
balloon ground station using the **[ECOM Repository](https://gitlab.com/team-aster/software/ecom)** software 
